  ...
  if (data.length > 0) {
    ...
    data.forEach(element => {
      ...
      if (haveComment) {
        ...
        htmlTask += '<td><label style="pointer-events: none" class="lblAttach" data-id='+element._id+' for="fileAttachData'+element._id+'"><i class="fas fa-lg fa-paperclip mr-1" data-groupid='+element.group_id+' data-id="' + element._id + '"></i><input accept=".doc,.docx,application/pdf,.xlsx,.xls,image/x-png,image/jpeg" data-id=' + element._id + ' data-groupid='+element.group_id+' id="fileAttachData'+element._id+'" class="d-none fileAttachData" multiple type="file" /></label><i style="cursor:pointer;" class="commentTask far fa-lg fa-comment mr-1" style="color:orange;" data-available="true" data-groupid=' + element.group_id + ' data-toggle="modal" data-target="#commentModal" data-name="' + element.name + '" data-id=' + element._id + '><i style="cursor:pointer;" class="delTask fas fa-trash ml-1" data-groupid="' + element.group_id + '" data-name="' + element.name + '" data-id=' + element._id + '></i></td></tr>';
      } else {
        window['dataComment' + element._id + ''] = [];
        if (haveTeam) window['dataCommentTeam' + element.group_id + ''] = element.member
        else window['dataCommentTeam' + element.group_id + ''] = [];
        htmlTask += '<td><label style="pointer-events: none" class="lblAttach" data-id='+element._id+' for="fileAttachData'+element._id+'"><i class="fas fa-lg fa-paperclip mr-1" data-groupid='+element.group_id+' data-id="' + element._id + '"></i><input accept=".doc,.docx,application/pdf,.xlsx,.xls,image/x-png,image/jpeg" data-id=' + element._id + ' data-groupid='+element.group_id+' id="fileAttachData'+element._id+'" class="d-none fileAttachData" multiple type="file" /></label><i style="cursor:pointer;" class="commentTask far fa-lg fa-comment mr-1" data-available="false" data-groupid=' + element.group_id + ' data-toggle="modal" data-target="#commentModal" data-name="' + element.name + '" data-id=' + element._id + '></i><i style="cursor:pointer;" class="delTask fas fa-trash fa-lg" data-groupid="' + element.group_id + '" data-name="' + element.name + '" data-id=' + element._id + '></i></td></tr>';
      }
